      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button
            ...
            onClick={() => router.push("/orcamentos/nova")}
          >
            + Novo Orçamento
          </Button>
        </div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <h3 className="text-lg font-bold text-white truncate max-w-[200px]">
                      {o.cris_tech_clientes?.nome || "Sem cliente"}
                    </h3>
                    <p className="text-sm text-[#9CA3AF]">
                      Emissão: {formatDate(o.data_emissao)}
                    </p>
                  </div>
                  <span className={`rounded-full px-2 py-0.5 text-[10px] font-bold uppercase ${STATUS_COLORS[o.status] ?? "bg-[#1E1E1E]"}`}>
                    {o.status}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-[#1E1E1E] pt-4">
                  <div>
                    ...
                    <p className="text-sm font-bold text-white">{formatCurrency(totalOrcamento(o))}</p>
                  </div>
                  <div>
                    <p className="text-[10px] uppercase font-bold text-[#4B5563]">Validade</p>
                    <p className="text-sm text-[#9CA3AF]">{formatDate(o.data_validade) || "—"}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button
                    variant="secondary"
                    className="flex-1 py-1 px-4 text-xs h-9"
                    onClick={() => router.push(`/orcamentos/${o.id}/editar`)}
                  >
